...
<div id="wrapper">
    <div id="headercontainer">
        ...
        <div class="column middle">
            <!-- indexer: on -->
            <h1 class="title">Asking Alexandria</h1>
            <div class="richText" id="elementscontainer">
               Asking Alexandria is een band uit het metal genre

                <img src="./img/AskingAlexandria.jpg" alt="AskingALexandria" title="AskingAlexandria" height="86" width="53">

                <?php
                if (isset($_SESSION['userrole'])) {
                    ?>
                    <form action='http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/Kaartverkoop.php' method='post'>
                        <td><input type='submit' value='Nu bestellen!' name='bestellen'/></td>
                    </form>
                    <?php
