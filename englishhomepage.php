...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/index.php?content=termsofuse">Terms of Use</a>
                    </li>
                    <li>
                        <a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/index.php?content=bestelprocedure">Bestelprocedure</a>
                    </li>
                    <li>
    ...
    <h1 style="text-align:center">Welcome to the website of Bonsai Shop Online</h1> 
<h1 style="text-align:center">Acties!</h1>
<div style="text-align:right;" ;>
    Bent u nederlands? klik hier om de site in het nederlands te bekijken.
    <br />
    <a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/index.php?content=algemeneHomepage">
        <img src="./img/netherlands.jpg" style="width:70px; height:70px;" />
    </a>
</div>
    <br />
    <br />
            ...
            <div class="col-sm-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <img src="./img/CarmonaActie.jpg" class="img-responsive" style="width:100%" alt="Image" />
                    </div>
                    <div class="panel-footer">Featured Product</div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <img src="./img/AcerActie.jpg" class="img-responsive" style="width:100%" alt="Image" />
                    </div>
                    <div class="panel-footer">Featured Product</div>
                </div>
            </div>
