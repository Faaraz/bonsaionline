...
<div id="wrapper">
    <div id="headercontainer">
        ...
        <div class="column middle">
            <!-- indexer: on -->
            <h1 class="title">Crown the Empire</h1>
            <div class="richText" id="elementscontainer">
               Crown the Empire is een band uit het metal genre

                <img src="./img/CrownTheEmpire.jpg" alt="CrownTheEmpire" title="CrownTheEmpire" height="86" width="53">
