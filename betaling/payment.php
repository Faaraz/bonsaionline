    ...
    <div id="headercontainer">
        ...
        <div id="nav">
            ...
            <ul class="big">
                ...
                <li class="active"><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/Kaartverkoop.php">Kaartverkoop</a></li>
                <?php
        ...
        <div class="column left navigation">
            <div class="subnav">
                <ul>
                    <li><a href="/web/Contact/Paradiso.htm" class="nav" title="Paradiso">Paradiso</a></li>
                    <li><a href="/web/Contact/Stichtingen.htm" class="nav" title="Stichtingen">Stichtingen</a></li>
                </ul>
            </div>
        ...
        <div class="column middle">
            ...
            <div class="richText" id="elementscontainer">
                ...
                $sql = "UPDATE optreden SET aantalKaarten = aantalKaarten -1 WHERE `id` = '".$_GET['id']."'";
