...
<head>
    <!-- indexer: on -->
    <title>Memento - Videotheek</title>
    <!-- indexer: off -->
        ...
        <div class="column left navigation">
            <div class="subnav">
                <ul>
                    ...
                    <li><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/Contact.html" class="nav" title="Contact">Contact</a></li>
                </ul>
            </div>
            <div style="float: left; clear: both; width: 0px; height: 529px;" class="height-sync-element"></div></div>
        <div class="column middle">
            <!-- indexer: on -->
            <h1 class="title">Shutter Island</h1>
            <div class="richText" id="elementscontainer">

                <img src="./img/Shutterisland.jpg" alt="Shawshank Redemption" title="Shawshank Redemption">

                Omschrijving:
                Shutter Island is een thriller film uit het jaar 2010.
                <br>
                Acteur(s):
                Leonardo DiCaprio
                Emily Mortimer
                ...
                if (isset($_SESSION['userrole'])) {
                    ?>
                    <form action='http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/index.php?content=videoverhuur' method='post'>
                        <td><input type='submit' value='Film Huren!' name='Film Huren!'/></td>
                    </form>
                    <?php

                }  else{
                    ?>
                    U bent niet ingelogd en kunt daarom deze film niet huren.
                    <?php
                }
