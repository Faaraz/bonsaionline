...
<body>
    ...
    <form action="index.php?content=complaintsview" method="post">

        <input type="radio" name="search_type" value="Filteren op status">Filteren op status
 ...
 <?php
 //Dynamisch tabel opbouwen en alle klachten weergeven
...
try {
     ...
     $query = "SELECT * FROM klachten order by id asc";
 ...
 ?>
     <br />Klachten afhandelen, voer het klacht ID en selecteer de juiste optie.

<form action="index.php?content=complaintfinish" method="post">
 <br>Klacht ID:<br><input type="text" name="klachtid">
<select name="klachtjudgement">
         <option value="Veranderde behoefte klant">Veranderde behoefte klant</option>
         <option value="Een te hoge verwachting">Een te hoge verwachting</option>
         <option value="Onterechte Klacht">Onterechte Klacht</option>
         <option value="Klacht over de prijs">Klacht over de prijs</option>
      <option value="Klacht over product">Klacht over product</option>
    <option value="Prijsonderhandelingsklacht">Prijsonderhandelingsklacht</option>
    <option value="Terugkomende klacht">Terugkomende klacht</option>
    <option value="Zeurende klacht">Zeurende klacht</option>
</select> 
