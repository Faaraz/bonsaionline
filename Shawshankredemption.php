...
<div id="wrapper">
    <div id="headercontainer">
            ...
            <ul class="small">
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/index.php?content=videoverhuur">Film Aanbod</a></li>
        ...
        <div class="column middle">
            <!-- indexer: on -->
            <h1 class="title">Shawshank Redemption</h1>
            <div class="richText" id="elementscontainer">

                <img src="./img/shawshankredemption.jpg" alt="Shawshank Redemption" title="Shawshank Redemption">

                Omschrijving:
                The Shawshank Redemption is een film uit 1994.
<br>
                Acteur(s):
                Tim Robbins
                Morgan Freeman
