...
<head>
	<!-- indexer: on -->
	<title>Videotheek - Film aanbod</title>
	<!-- indexer: off -->
	...
	<!--[if lte IE 8]>
	<![endif]-->
	<script src="http://bam.nr-data.net/1/74dd0a7c08?a=4990578&amp;v=852.a36f0fd&amp;to=bldbMhFQDUBWU00NDVcdczUzHjR2dR1wKiQWQksJCVQARxheVTsGQFxYCwpFPENWQlgAC0pdSRQGQgZdQ1FNDQ1XHUkHBFRMW1hdXEoISkI%3D&amp;ap=165&amp;be=344&amp;fe=5897&amp;dc=4177&amp;f=%5B%5D&amp;perf=%7B%22timing%22:%7B%22of%22:1455528082094,%22n%22:0,%22dl%22:73,%22di%22:465,%22ds%22:1125,%22de%22:4520,%22dc%22:6239,%22l%22:6239,%22le%22:6485,%22f%22:1,%22dn%22:16,%22dne%22:20,%22c%22:20,%22ce%22:20,%22rq%22:22,%22rp%22:65,%22rpe%22:102%7D,%22navigation%22:%7B%7D%7D&amp;jsonp=NREUM.setToken" type="text/javascript"></script><script src="http://js-agent.newrelic.com/nr-852.min.js"></script><script src="http://www.google-analytics.com/analytics.js" async="" type="text/javascript"></script><script src="//www.googletagmanager.com/gtm.js?id=GTM-THVHMZ" async=""></script><script src="http://stats.g.doubleclick.net/dc.js" async="" type="text/javascript"></script><script src="//platform.twitter.com/widgets.js" id="twitter-wjs"></script><script src="//connect.facebook.net/nl_NL/all.js#xfbml=1" id="facebook-jssdk"></script>
	<script type="text/javascript" src="./js/jquery-1.9.1.min.js"></script>
	<script type="text/javascript" src="./js/agenda.inc.js"></script>
	<script type="text/javascript" src="./js/jquery.mousewheel.js" defer="defer"></script>
	<script type="text/javascript" src="./js/klass.js" defer="defer"></script>
	<script type="text/javascript" src="./js/agenda.inc.js" defer="defer"></script>
	<script type="text/javascript" src="./js/dynamit.jquery-ui.carousel-2.0.min.js" defer="defer"></script>
	<script type="text/javascript" src="./js/jsplayer-2.6.0/jquery.jplayer.min.js" defer="defer"></script>
	<script type="text/javascript" src="./js/js-fallback.js" defer="defer"></script>
	<script type="text/javascript" src="./js/paradiso.js" defer="defer"></script>
			...
			<ul class="small">
				<li>
					...
					<ul>
						...
						<li><a href="/web/Nieuws.htm">Nieuws</a></li>
						<li><a href="/web/Nieuwsbrief.htm">Nieuwsbrief</a></li>
						<li><a href="/web/Kaartverkoop.htm">Kaartverkoop</a></li>
						<li><a href="/web/clubparadiso.amsterdam.htm">Club Paradiso</a></li>
						<li><a href="http://www.paradisowinkel.nl/?___store=nl" target="_blank" onclick="_gaq.push(['_trackEvent','ExternalLinks','paradisowinkel.nl']);">Winkel </a></li>
						<li><a href="https://paradisovinylclub.nl/" target="_blank">Paradiso Vinyl Club</a></li>
						<li><a href="/web/Over-Paradiso.htm">Over Paradiso</a></li>
						<li class="active"><a href="/web/Contact.htm">Contact</a></li>
					</ul>
				</li>
			</ul>
			<ul class="big">
				...
				<li class="active"><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les 1/Kaartverkoop.php">Film Aanbod</a></li>
				<?php
				...
				<?php
				if (isset($_SESSION['userrole'])) {
					echo "<li><a href='index.php?content=customerHomepage'>Account Portaal</a></li>";
...
//echo '<td>Verwijder<input type="checkbox" name="remove_code[]" value="'.$product_code.'" /> </td>';
	...
	echo '<td colspan="4">';
	echo '<button type="submit">Update</button><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/view_cart.php" class="button" style="font-size:12px; color:white;">Kassa</a>';
	echo '</td>';
	echo '</tbody>';
	echo '</table>';
	$current_url = urlencode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
