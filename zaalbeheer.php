<?php
session_start();
include('./classes/MySqlDatabaseClass.php');

$userrole = array("root", "zaalbeheerder");
...
else
{
    ...
    <head>
        <!-- indexer: on -->
        <title>Paradiso - Optredenbeheer</title>
        <!-- indexer: off -->
        ...
        <div id="headercontainer">
            ...
            <div id="nav">
                ...
                <ul class="big">
                    ...
                    <li><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les 1/Kaartverkoop.php">Kaartverkoop</a></li>
                    <?php
            ...
            <div class="column middle">
                ...
                <div class="richText" id="elementscontainer">
                    <table>
                        <middle><h3>Optredens</h3></middle>
                        <tr>
                            <th>Id</th>
                            <th>Naam Optreden</th>
                            <th>Aantal beschikbare kaarten</th>
                            <th></th>
                            <th></th>
                        </tr>
                       <?php
             ...
             <td>".$record["id"]."</td>
             <td>".$record["naam"]."</td>
             <td>".$record["aantalKaarten"]."</td>
             <td>
              <a href='./deleteOptreden.php?id=".$record['id']."'>
                <img src='./img/deleteOptreden.png' alt='delete' />
              </a>
             </td>
            </tr>";
                        }
