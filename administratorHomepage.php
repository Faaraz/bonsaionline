...
<head>
    <!-- indexer: on -->
    <title>Paradiso - Klantenpagina</title>
    <!-- indexer: off -->
    ...
    <div id="headercontainer">
        ...
        <div id="nav">
            <ul class="small">
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les 1/administratorHomepage.php">Kaartverkoop</a></li>
            ...
            <ul class="big">
                ...
                <li><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/Kaartverkoop.php">Kaartverkoop</a></li>
                <li class="active"><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/index.php?content=customerHomepage">Account Portaal</a></li>
                <?php
        ...
        <div class="column left navigation">
            <div class="subnav">
                <ul>
                    <li><a href="http://localhost/2014-2015/InlogRegistratieSysteem/Les%201/zaalbeheer.php">Optredenbeheer</a></li>
