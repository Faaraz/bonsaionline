...
<body>
 ...
 try {
     ...
     $query = "SELECT ProductCode, ProductNaam  FROM favorieten where klantid = $sessionid order by id asc";
 ...
 ?>
 <br />
 Wilt u favorieten verwijderen? Vul hieronder de product code van het product in om het product uit uw favorieten te verwijderen.

<form action="index.php?content=deletefavorites" method="post">
